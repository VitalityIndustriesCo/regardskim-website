  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-cream px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="mt-8 rounded-2xl border border-slate/12 bg-[var(--surface-card)] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.07)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.24)] sm:p-8">
