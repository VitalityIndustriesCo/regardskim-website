  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-cream px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="mt-8 rounded-2xl border border-slate/12 bg-white p-6 shadow-[0_8px_22px_rgba(35,53,71,0.14),0_2px_5px_rgba(35,53,71,0.08)] dark:bg-[#20283A] sm:p-8">
