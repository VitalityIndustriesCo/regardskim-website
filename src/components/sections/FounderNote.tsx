        ...
        <FadeIn className="mx-auto max-w-4xl rounded-[2rem] border border-[#E3D3C6] bg-white p-8 shadow-[0_12px_30px_rgba(35,53,71,0.16),0_3px_8px_rgba(35,53,71,0.09)] dark:border-slate/15 dark:bg-[#20283A] md:p-12">
          <div className="flex flex-col items-center gap-8 md:flex-row md:items-start">
            <Image
              ...
              alt="Matt, founder of Regards Kim"
              width={160}
              height={200}
              className="h-44 w-36 shrink-0 rounded-3xl object-cover shadow-[0_10px_24px_rgba(35,53,71,0.20)]"
            />
            <div className="text-center md:text-left">
              <p className="text-sm font-bold uppercase tracking-[0.14em] text-brass">A note from the founder</p>
              <blockquote className="mt-4 text-lg leading-8 text-ink md:text-xl">
                &ldquo;I ran ecommerce stores for ten years. The best support person I ever worked with was named Kim —
                she could turn an angry customer into a loyal one in two sentences. Regards Kim exists so every store
                owner gets their own Kim.&rdquo;
              </blockquote>
              <p className="mt-5 font-bold text-ink">Matt · Founder, Regards Kim</p>
