        ...
        <FadeIn className="mx-auto max-w-5xl text-center">
          <div className="mx-auto max-w-4xl pt-20 md:pt-32">
            ...
            <div className="mx-auto mt-6 flex flex-wrap items-center justify-center gap-3">
              <span className="inline-flex items-center gap-2 rounded-full border border-[#E3D3C6] bg-white/80 px-4 py-2 text-xs font-bold uppercase tracking-[0.14em] text-[#8A6F61] shadow-sm backdrop-blur dark:border-slate/15 dark:bg-[#1B2436]/80 dark:text-brass"><ShopifyLogo className="h-5 w-5" /> Built for Shopify</span>
              <span className="inline-flex items-center gap-2 rounded-full border border-[#E3D3C6] bg-white/80 px-4 py-2 text-xs font-bold uppercase tracking-[0.14em] text-[#8A6F61] shadow-sm backdrop-blur dark:border-slate/15 dark:bg-[#1B2436]/80 dark:text-brass"><GmailLogo className="h-4 w-4" /> Connects to Gmail</span>
            </div>
