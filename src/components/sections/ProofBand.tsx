...
function Stars({ label }: { label: string }) {
  return (
    <div className="flex gap-1 text-brass" aria-label={label}>
...
type ProofBandProps = {
  copy?: HomeCopy["proofBand"];
};

export default function ProofBand({ copy = enHomeCopy.proofBand }: ProofBandProps) {
  return (
