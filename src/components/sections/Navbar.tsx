    ...
    <>
      ...
      >
        <nav className="section-shell flex h-20 items-center justify-between" aria-label="Primary">
          ...
          <button
            type="button"
            className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate/15 bg-[#111827] text-ink transition-all duration-200 hover:border-brass/40 hover:bg-mist focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brass focus-visible:ring-offset-2 md:hidden"
      ...
      <div
        ...
        className={`fixed right-0 top-0 z-50 flex h-screen w-full max-w-sm flex-col border-l border-slate/10 bg-[#111827] shadow-[-8px_0_32px_rgba(0,0,0,0.4)] transition-transform duration-300 ease-out md:hidden ${
