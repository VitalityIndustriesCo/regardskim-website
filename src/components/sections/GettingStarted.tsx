        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {steps.map((step, index) => (
            <FadeIn key={step.number} delay={index * 0.08}>
              <div className="flex h-full items-center gap-4 rounded-2xl border border-slate/10 bg-[#111827] p-5 shadow-[0_4px_20px_rgba(0,0,0,0.06),0_1px_3px_rgba(0,0,0,0.04)] md:flex-col md:items-start md:p-6">
