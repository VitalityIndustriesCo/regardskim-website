          ...
          {faqs.map((faq, idx) => {
            ...
            return (
              <FadeIn key={faq.q} delay={idx * 0.02}>
                <article className="overflow-hidden rounded-2xl border border-slate/12 bg-[var(--surface-card)] shadow-[0_2px_8px_rgba(0,0,0,0.04)] dark:shadow-[0_8px_20px_rgba(0,0,0,0.22)]">
                  <button
                    type="button"
