        ...
        <div className="mt-10 space-y-6 md:mt-14 md:space-y-8">
          {steps.map((step, idx) => (
            <FadeIn key={step.number} delay={idx * 0.06}>
              <article className="rounded-[2rem] border border-slate/15 bg-cream p-4 shadow-[0_16px_44px_rgba(0,0,0,0.3),0_1px_4px_rgba(0,0,0,0.2)] sm:p-5 md:rounded-[2.5rem] md:p-6 lg:p-8">
                ...
                <div className="rounded-[1.5rem] border border-slate/12 bg-forest p-3 sm:p-4 md:rounded-[2rem] md:p-5 lg:p-6">
                  {step.mockup}
                </div>
              </article>
            </FadeIn>
