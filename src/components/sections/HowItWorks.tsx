...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="bg-[var(--surface-well)] py-16 md:py-24">
        ...
        <div className="mt-10 space-y-6 md:mt-14 md:space-y-8">
          {steps.map((step, idx) => (
            <FadeIn key={step.number} delay={idx * 0.06}>
              <article className="rounded-[2rem] border border-slate/15 bg-[var(--surface-card)] p-4 shadow-[0_16px_44px_rgba(35,53,71,0.08),0_1px_4px_rgba(35,53,71,0.04)] dark:shadow-[0_18px_48px_rgba(0,0,0,0.26)] sm:p-5 md:rounded-[2.5rem] md:p-6 lg:p-8">
                ...
                <div className="rounded-[1.5rem] border border-slate/12 bg-[var(--surface-well)] p-3 sm:p-4 md:rounded-[2rem] md:p-5 lg:p-6">
                  {step.mockup}
                </div>
              </article>
            </FadeIn>
