  ...
  return (
    <section id="founding" className="bg-paper py-16 md:py-24">
      <div className="section-shell">
        ...
        <FadeIn delay={0.06}>
          <div className="mx-auto mt-10 max-w-sm rounded-2xl border border-slate/12 bg-[#111827] p-6 text-center shadow-[0_4px_20px_rgba(0,0,0,0.07)]">
        ...
        <FadeIn delay={0.1}>
          <div className="mx-auto mt-8 max-w-lg rounded-3xl border border-slate/12 bg-[#111827] p-6 shadow-[0_8px_40px_rgba(0,0,0,0.08),0_2px_6px_rgba(0,0,0,0.04)] md:p-10">
            {status === "success" ? (
                ...
                <form onSubmit={handleSubmit} className="mt-7 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate/20 bg-mist px-4 py-3 text-sm text-ink placeholder:text-slate/50 focus:border-brass focus:bg-cream focus:outline-none focus:ring-1 focus:ring-brass/30"
