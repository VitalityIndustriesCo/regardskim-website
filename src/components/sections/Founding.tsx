  ...
  return (
    <section id="founding" className="bg-paper py-16 md:py-24">
      <div className="section-shell">
        ...
        <FadeIn delay={0.06}>
          <div className="mx-auto mt-10 max-w-sm rounded-2xl border border-slate/12 bg-white p-6 text-center shadow-[0_4px_20px_rgba(0,0,0,0.07)] dark:bg-[#111827]">
        ...
        <FadeIn delay={0.1}>
          <div className="mx-auto mt-8 max-w-lg rounded-3xl border border-slate/12 bg-white p-6 shadow-[0_8px_40px_rgba(0,0,0,0.08),0_2px_6px_rgba(0,0,0,0.04)] dark:bg-[#111827] md:p-10">
            {status === "success" ? (
