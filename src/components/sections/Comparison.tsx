...
function ComparisonCard({ title, items, tone }: ComparisonCardProps) {
  ...
  return (
    <article
      className={[
        "h-full rounded-[1.75rem] border bg-[#0F1B2E] p-6 md:p-8",
        isKim
...
function ReplyCard({ label, body, tone }: ReplyCardProps) {
  ...
  if (!isKim) {
    return (
      <article className="h-full rounded-[1.75rem] border border-slate/12 bg-[#0F1B2E] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.06),0_1px_3px_rgba(0,0,0,0.04)] md:p-8">
  ...
  return (
    <article className="h-full rounded-[1.75rem] border-2 border-brass/30 bg-[#0F1B2E] p-6 shadow-[0_8px_32px_rgba(176,141,87,0.15),0_2px_6px_rgba(0,0,0,0.06)] md:p-8">
  ...
  return (
    <section className="bg-paper py-16 md:py-24">
      <div className="section-shell">
        ...
        <FadeIn delay={0.12}>
          <div className="mx-auto mt-10 max-w-4xl rounded-[1.75rem] border border-slate/12 bg-[#0F1B2E] px-6 py-5 text-center shadow-[0_4px_20px_rgba(0,0,0,0.06)] md:px-8 md:py-6">
