...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-slate/10 bg-[#111827] py-12">
          ...
          <form onSubmit={handleSubscribe} className="mt-6">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-full max-w-[220px] rounded-lg border border-slate/20 bg-mist px-3 py-2 text-sm text-ink placeholder:text-slate/50 focus:border-brass focus:bg-cream focus:outline-none focus:ring-2 focus:ring-brass/30"
              />
              <button
                type="submit"
            ...
            {status === "success" && (
              <p className="mt-2 text-xs text-emerald-400">You&apos;re in! We&apos;ll keep you posted.</p>
            )}
            {status === "error" && (
