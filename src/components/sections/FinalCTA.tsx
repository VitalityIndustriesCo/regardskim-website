  ...
  return (
    <section className="bg-mist py-16 md:py-24">
      <div className="section-shell">
        <FadeIn className="mx-auto max-w-3xl rounded-[2rem] border border-brass/20 bg-[#111827] px-8 py-12 text-center shadow-[0_8px_40px_rgba(176,141,87,0.12),0_2px_8px_rgba(0,0,0,0.06)] md:px-12 md:py-16">
