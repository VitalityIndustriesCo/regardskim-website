  ...
  return (
    <section id="pricing" className="bg-mist py-16 md:py-28">
      <div className="section-shell text-center">
        ...
        <FadeIn delay={0.06} className="mx-auto mt-10 w-full max-w-md rounded-[1.5rem] border border-slate/12 bg-cream p-5 text-left shadow-[0_8px_40px_rgba(0,0,0,0.10),0_2px_6px_rgba(0,0,0,0.05)] md:rounded-[2rem] md:p-10">
