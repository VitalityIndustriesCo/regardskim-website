  ...
  return (
    <div className="relative mx-auto max-w-6xl">
      <div className="overflow-hidden rounded-[2rem] border border-[#E3D3C6] bg-[#FFF9F3] shadow-[0_34px_110px_rgba(35,53,71,0.24),0_18px_45px_rgba(233,124,107,0.14)]">
        ...
        <div className="grid gap-5 bg-[radial-gradient(circle_at_20%_20%,rgba(233,124,107,0.10),transparent_30%),linear-gradient(180deg,#FFF9F3,#F8F1E7)] p-4 md:grid-cols-[1fr_1.08fr_0.82fr] md:p-7">
          <section className="rounded-[1.5rem] border border-[#E9DCD1] bg-white p-4 shadow-[0_18px_40px_rgba(35,53,71,0.14)]">
            ...
            <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-[#FFF0ED] px-3 py-1.5 text-xs font-bold text-[#B85345]">
          ...
          <section className="rounded-[1.5rem] border border-[#E9DCD1] bg-white p-4 shadow-[0_22px_48px_rgba(35,53,71,0.16)]">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <span className="rounded-full bg-[#E97C6B] px-4 py-2 text-xs font-bold text-white shadow-[0_8px_18px_rgba(233,124,107,0.28)]">Approve & send</span>
              <span className="rounded-full border border-[#E3D3C6] bg-white px-4 py-2 text-xs font-bold text-ink">Edit draft</span>
              <span className="rounded-full border border-[#E3D3C6] bg-white px-4 py-2 text-xs font-bold text-ink">Skip</span>
            </div>
          </section>
          ...
          <section className="rounded-[1.5rem] border border-[#CFE3D1] bg-[#F8FCF6] p-4 shadow-[0_18px_40px_rgba(56,109,52,0.13)]">
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#5F7F4A]">Shopify order</p>
                <h3 className="font-display text-xl font-extrabold text-ink">Matched data</h3>
              </div>
            </div>
            <div className="space-y-3">
              {orderFacts.map(([label, value]) => (
                <div key={label} className="rounded-2xl border border-[#DCEBDA] bg-white px-4 py-3">
                  <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-[#6B8D60]">{label}</p>
                  <p className="mt-1 text-sm font-extrabold text-ink">{value}</p>
                </div>
              ))}
            </div>
            <div className="mt-4 flex items-center gap-2 rounded-2xl bg-white px-4 py-3 text-xs font-semibold text-slate">
      ...
      <div className="mx-auto mt-5 flex max-w-3xl flex-wrap items-center justify-center gap-3 text-xs font-semibold text-slate">
        ...
        <span className="hidden h-1 w-1 rounded-full bg-[#C9B5A7] sm:block" />
