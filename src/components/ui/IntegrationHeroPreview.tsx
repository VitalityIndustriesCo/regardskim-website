...
export default function IntegrationHeroPreview() {
  return (
    <div className="relative mx-auto max-w-6xl">
      <div className="overflow-hidden rounded-[2rem] border border-slate/15 bg-[#0C1118] shadow-[0_34px_110px_rgba(0,0,0,0.5),0_18px_45px_rgba(176,141,87,0.15)]">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate/12 bg-[#111827]/80 px-5 py-4 backdrop-blur md:px-7">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs font-semibold">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-slate/15 bg-[#1B2436] px-3 py-1.5 text-emerald-400"><ShopifyLogo className="h-4 w-4" /> Shopify admin</span>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-slate/12 bg-[#1B2436] px-3 py-1.5 text-ink"><GmailLogo className="h-4 w-4" /> Gmail Connected</span>
        ...
        <div className="grid gap-5 bg-[radial-gradient(circle_at_20%_20%,rgba(176,141,87,0.12),transparent_30%),linear-gradient(180deg,#060B14,#1E2A3A)] p-4 md:grid-cols-[1fr_1.08fr_0.82fr] md:p-7">
          <section className="rounded-[1.5rem] border border-slate/12 bg-[#1B2436] p-4 shadow-[0_18px_40px_rgba(0,0,0,0.45)]">
            ...
            <div className="rounded-2xl border border-slate/12 bg-[#0C1118] p-4 shadow-[0_10px_26px_rgba(0,0,0,0.3)]">
              <div className="flex items-center gap-3">
          ...
          <section className="rounded-[1.5rem] border border-slate/12 bg-[#1B2436] p-4 shadow-[0_22px_48px_rgba(0,0,0,0.4)]">
            <div className="mb-4 flex items-center justify-between">
              <div>
              ...
              <span className="rounded-full bg-[#1B2436] px-3 py-1 text-xs font-bold text-emerald-400">98% ready</span>
            </div>
            <div className="rounded-2xl border border-slate/12 bg-[#0C1118] p-5 shadow-[0_12px_30px_rgba(0,0,0,0.3)]">
          ...
          <section className="rounded-[1.5rem] border border-slate/15 bg-[#1B2436] p-4 shadow-[0_18px_40px_rgba(0,0,0,0.35)]">
            ...
            <div className="space-y-3">
              {orderFacts.map(([label, value]) => (
                <div key={label} className="rounded-2xl border border-slate/12 bg-[#1B2436] px-4 py-3">
            ...
            <div className="mt-4 flex items-center gap-2 rounded-2xl bg-[#1B2436] px-4 py-3 text-xs font-semibold text-slate">
