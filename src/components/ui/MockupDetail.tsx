  ...
  return (
    <div ref={viewRef}>
      ...
      <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
        ...
        <div className="rounded-xl border border-slate/10 bg-[var(--surface-tile)] px-4 py-4 shadow-[0_4px_16px_rgba(0,0,0,0.10),0_1.5px_4px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_22px_rgba(0,0,0,0.28)]">
          {/* Sender header */}
        ...
        <div className="rounded-xl border border-slate/10 bg-[var(--surface-tile)] px-4 py-4 shadow-[0_4px_16px_rgba(0,0,0,0.10),0_1.5px_4px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_22px_rgba(0,0,0,0.28)] overflow-hidden">
          {mode === "draft" ? (
