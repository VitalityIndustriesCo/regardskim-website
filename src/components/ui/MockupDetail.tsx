  ...
  return (
    <div ref={viewRef}>
      ...
      <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
        ...
        <div className="rounded-xl border border-slate/10 bg-white px-4 py-4 shadow-[0_4px_16px_rgba(0,0,0,0.10),0_1.5px_4px_rgba(0,0,0,0.06)] dark:bg-[#1E2A3E] dark:shadow-[0_4px_16px_rgba(0,0,0,0.25)]">
          {/* Sender header */}
        ...
        <div className="rounded-xl border border-slate/10 bg-white px-4 py-4 shadow-[0_4px_16px_rgba(0,0,0,0.10),0_1.5px_4px_rgba(0,0,0,0.06)] dark:bg-[#1E2A3E] dark:shadow-[0_4px_16px_rgba(0,0,0,0.25)] overflow-hidden">
          {mode === "draft" ? (
