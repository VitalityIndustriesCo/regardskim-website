      ...
      <div className="space-y-2.5 px-1">
        {EMAILS.map((card) => (
          <div key={`${card.sender}-${card.subject}`} className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-slate/10 bg-[#1B2436] px-3 py-3 shadow-[0_4px_16px_rgba(0,0,0,0.25),0_1.5px_4px_rgba(0,0,0,0.15)] sm:px-4">
            ...
            <div className="rounded-xl border border-slate/10 bg-[#1B2436] shadow-[0_4px_16px_rgba(0,0,0,0.25),0_1.5px_4px_rgba(0,0,0,0.15)]">
