...
function AnnotationBadge({
  ...
  return (
    <div
      className={`pointer-events-none absolute hidden items-center gap-2 rounded-full border border-slate/15 bg-[#1B2436] px-3 py-2 text-xs font-medium text-ink shadow-[0_4px_16px_rgba(0,0,0,0.10)] md:flex ${className ?? ""}`}
    >
...
function InboxBadge({ children, tone = "muted" }: { children: ReactNode; tone?: "accent" | "muted" }) {
  const toneClass =
    tone === "accent"
      ...
      : "border-mist bg-[#1B2436]/60 text-slate";
  ...
  return (
    <div className="relative mt-14 w-full overflow-x-clip px-2 sm:px-0">
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="rounded-[1.5rem] border border-slate/12 bg-[#111827] shadow-[0_16px_48px_rgba(0,0,0,0.10),0_2px_8px_rgba(0,0,0,0.06)] sm:rounded-[2rem]">
          ...
          <div className="relative p-2.5 sm:p-4 md:p-5">
            <div className="space-y-3">
              <article className="rounded-[1.25rem] border border-brass/25 bg-brass/[0.08] p-3 text-left shadow-[0_12px_30px_rgba(176,141,87,0.12)] sm:rounded-[1.5rem] sm:p-4">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-3 rounded-[1rem] border border-brass/20 bg-[#1B2436] px-3 py-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] sm:mt-4 sm:rounded-[1.25rem] sm:px-4 sm:py-3">
                ...
                <div className="mt-3 flex justify-end md:hidden">
                  <div className="inline-flex max-w-full items-center gap-2 rounded-full border border-mist bg-[#1B2436] px-3 py-2 text-[11px] font-medium text-ink shadow-sm">
              ...
              <article className="rounded-[1.25rem] border border-mist bg-[#1B2436] p-3 text-left sm:rounded-[1.5rem] sm:p-4">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  <Avatar initial="J" />
                  <div className="min-w-0 flex-1">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
