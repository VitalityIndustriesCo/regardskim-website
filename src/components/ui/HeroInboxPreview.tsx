...
function AnnotationBadge({
  ...
  return (
    <div
      className={`pointer-events-none absolute hidden items-center gap-2 rounded-full border border-mist bg-cream px-3 py-2 text-xs font-medium text-ink shadow-[0_14px_30px_rgba(0,0,0,0.3)] md:flex ${className ?? ""}`}
    >
  ...
  return (
    <div className="relative mt-14 w-full overflow-x-clip px-2 sm:px-0">
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="rounded-[1.5rem] border border-mist bg-cream shadow-[0_24px_60px_rgba(0,0,0,0.4)] sm:rounded-[2rem]">
