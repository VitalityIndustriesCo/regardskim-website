...
function AnnotationBadge({
  ...
  return (
    <div
      className={`pointer-events-none absolute hidden items-center gap-2 rounded-full border border-slate/15 bg-[var(--surface-tile)] px-3 py-2 text-xs font-medium text-ink shadow-[0_4px_16px_rgba(0,0,0,0.10)] md:flex ${className ?? ""}`}
    >
  ...
  return (
    <div className="relative mt-14 w-full overflow-x-clip px-2 sm:px-0">
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="rounded-[1.5rem] border border-slate/12 bg-[var(--surface-mockup)] shadow-[0_16px_48px_rgba(0,0,0,0.10),0_2px_8px_rgba(0,0,0,0.06)] dark:shadow-[0_20px_56px_rgba(0,0,0,0.32)] sm:rounded-[2rem]">
