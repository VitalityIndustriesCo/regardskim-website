        ...
        <div className="rounded-[1.5rem] border border-forest/12 bg-paper shadow-[0_24px_60px_rgba(26,26,26,0.10)] sm:rounded-[2rem]">
          ...
          <div className="relative p-2.5 sm:p-4 md:p-5">
            <div className="space-y-3">
              <article className="rounded-[1.25rem] border border-brass/18 bg-brass/[0.06] p-3 text-left shadow-[0_12px_30px_rgba(232,93,58,0.08)] sm:rounded-[1.5rem] sm:p-4">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  <Avatar initial="S" tone="accent" />
                  <div className="min-w-0 flex-1">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex min-w-0 flex-wrap items-center gap-2">
                        <p className="text-[13px] font-semibold text-forest sm:text-[15px]">Sarah M.</p>
                        <InboxBadge tone="accent">To Respond</InboxBadge>
                      </div>
                      <span className="text-[10px] text-slate sm:text-[11px]">Now</span>
                    </div>
                    <p className="mt-2 text-[13px] font-semibold text-forest sm:text-sm">Where is my order?</p>
                    ...
                    <div className="mt-3 rounded-[1rem] border border-brass/15 bg-paper px-3 py-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.5)] sm:mt-4 sm:rounded-[1.25rem] sm:px-4 sm:py-3">
              ...
              <article className="rounded-[1.25rem] border border-forest/10 bg-paper p-3 text-left sm:rounded-[1.5rem] sm:p-4">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  <Avatar initial="J" />
                  <div className="min-w-0 flex-1">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex min-w-0 flex-wrap items-center gap-2">
                        <p className="text-[13px] font-semibold text-forest sm:text-[15px]">James T.</p>
                        <InboxBadge>Return Request</InboxBadge>
                      </div>
                      <span className="text-[10px] text-slate sm:text-[11px]">1:15 PM</span>
                    </div>
                    <p className="mt-2 text-[13px] font-semibold text-forest sm:text-sm">Return request for order #1836</p>
                    <p className="mt-1 text-[13px] leading-5 text-slate sm:text-sm sm:leading-6">
              ...
              <article className="rounded-[1.25rem] border border-forest/10 bg-paper p-3 text-left sm:rounded-[1.5rem] sm:p-4">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex min-w-0 flex-wrap items-center gap-2">
                        <p className="text-[13px] font-semibold text-forest sm:text-[15px]">Michael R.</p>
                        <InboxBadge>Refund</InboxBadge>
                      </div>
                      <span className="text-[10px] text-slate sm:text-[11px]">11:42 AM</span>
                    </div>
                    <p className="mt-2 text-[13px] font-semibold text-forest sm:text-sm">Damaged item received</p>
                    <p className="mt-1 text-[13px] leading-5 text-slate sm:text-sm sm:leading-6">
