    ...
    <main className="bg-paper py-16 sm:py-20">
      <div className="section-shell">
        <div className="mx-auto max-w-[720px]">
          ...
          <section className="mt-16 rounded-[2rem] border border-brass/25 bg-[var(--surface-card)] px-6 py-8 shadow-[0_4px_24px_rgba(176,141,87,0.10)] dark:shadow-[0_10px_30px_rgba(0,0,0,0.24)] sm:px-8">
