    ...
    <div className="flex min-h-screen flex-col bg-paper">
      ...
      <main className="flex flex-1 items-center justify-center px-4 pb-16 pt-8">
        <div className="w-full max-w-xl">
          ...
          {/* Form card */}
          <div className="mx-auto mt-8 max-w-sm rounded-2xl border border-slate/12 bg-white p-6 shadow-[0_8px_32px_rgba(0,0,0,0.08),0_2px_6px_rgba(0,0,0,0.04)] dark:bg-[#20283A]">
            {status === "success" ? (
