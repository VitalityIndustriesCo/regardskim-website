...
export default function FoundingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-paper">
      ...
      <header className="border-b border-slate/10 bg-white px-6 py-5 dark:bg-[#202739]">
      ...
      <main className="flex flex-1 items-center justify-center px-4 pb-16 pt-8">
        <div className="w-full max-w-xl">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <div className="flex items-center gap-2 rounded-full border border-slate/15 bg-white px-3 py-2 shadow-sm dark:border-slate/15 dark:bg-[#252E42]">
          ...
          {/* Form card */}
          <div className="mx-auto mt-8 max-w-sm rounded-2xl border border-slate/12 bg-white p-6 shadow-[0_8px_32px_rgba(0,0,0,0.08),0_2px_6px_rgba(0,0,0,0.04)] dark:bg-[#202739]">
            {status === "success" ? (
