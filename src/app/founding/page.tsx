...
export default function FoundingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-paper">
      ...
      <header className="border-b border-slate/10 bg-[#111827] px-6 py-5">
      ...
      <main className="flex flex-1 items-center justify-center px-4 pb-16 pt-8">
        <div className="w-full max-w-xl">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <div className="flex items-center gap-2 rounded-full border border-slate/15 bg-[#1B2436] px-3 py-2 shadow-sm">
          ...
          {/* Form card */}
          <div className="mx-auto mt-8 max-w-sm rounded-2xl border border-slate/12 bg-[#111827] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.08),0_2px_6px_rgba(0,0,0,0.04)]">
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate/20 bg-mist px-4 py-3 text-sm text-ink placeholder:text-slate/50 focus:border-brass focus:bg-[#1B2436] focus:outline-none focus:ring-1 focus:ring-brass/30"
