      ...
      <section className="section-shell">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          {blogPosts.map((post) => (
            <article
              key={post.slug}
              className="group flex h-full flex-col rounded-[1.75rem] border border-slate/10 bg-white p-7 shadow-[0_4px_24px_rgba(0,0,0,0.07),0_1px_3px_rgba(0,0,0,0.04)] dark:bg-[#20283A] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.12)]"
            >
              {post.image && (
