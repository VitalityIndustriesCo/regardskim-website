  ...
  return (
    <LegalPageLayout title="Privacy Policy" updatedAt="April 6, 2026">
      ...
      <p>
        ...
        AI auto-drafted reply assistance from Shopify context, and keeps you in control before anything is sent.
      </p>
      ...
      <p>
        ...
        AI auto-drafted reply assistance, and operate the service.
      </p>
      ...
      <ul>
        ...
        <li>
          Use order, tracking, and policy data to make AI auto-drafted reply assistance more accurate and useful
        </li>
      ...
      <p>
        ...
        context and AI auto-drafted reply assistance. Data that may be received from Shopify includes:
      </p>
      <ul>
