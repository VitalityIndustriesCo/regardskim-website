  ...
  return (
    <main>
      ...
      <section className="bg-mist py-14 md:py-20">
        <div className="section-shell">
          <div className="grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-slate/10 bg-[#111827] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.06),0_1px_3px_rgba(0,0,0,0.04)]">
      ...
      <section id="apply" className="bg-paper py-16 md:py-24">
        <div className="section-shell">
          <div className="mx-auto max-w-2xl rounded-3xl border border-slate/12 bg-[#111827] p-6 shadow-[0_8px_40px_rgba(0,0,0,0.08),0_2px_6px_rgba(0,0,0,0.04)] md:p-10">
